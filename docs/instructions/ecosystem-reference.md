...
Links to official OpenCode ecosystem resources and community hubs.
...
|----------|-----|-------------|
| Official ecosystem page | https://opencode.ai/docs/ecosystem/ | Complete list of plugins, projects, and agents maintained by OpenCode team |
| awesome-opencode | https://github.com/awesome-opencode/awesome-opencode | Community curated awesome list |
| opencode.cafe | https://opencode.cafe | Community hub aggregating ecosystem projects |
